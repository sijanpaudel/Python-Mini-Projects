...
if answer == "left":
    answer = input("You come to a river, you can walk around it or swim accross it? Type walk to walk around and swim to swim accross: ")
    ...
    if answer == "back":
        ...
        if answer == "yes":
            ...
            print("You ignore the stranger and they are offended. You lost")
